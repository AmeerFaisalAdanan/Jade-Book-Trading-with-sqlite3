					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						// Purchase successful. We can terminate
                                                ...
                                                try{
                                                    ...
                                                    System.out.println("Database Connected! Purchasing books...");
                                                    ...
                                                    String remove_books = "DELETE FROM catalogues WHERE bookTitle = '" +targetBookTitle+ "'AND bookPrice = '" +bestPrice+ "'";
                                                    
                                                    
                                                    st.execute(remove_books);
                                                    System.out.println("Database Connected! "+targetBookTitle+ " removed from catalogue");
